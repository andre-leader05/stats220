...
max_day_num <- days[which.max(avg_week)]
```
...
The Toyota Aqua colour spotted in the most trips was **`r main_colour`** which was spotted in **`r main_colour_num`** trips. This suggests that you are most likely to encounter a **`r main_colour`** Toyota Aqua.
